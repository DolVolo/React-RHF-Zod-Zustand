...
function App() {
  console.log('App rendering - All components except CourseDrop (debugging)');
    ...
    <div className="app">
      ...
      <main className="app-main" style={{maxWidth: '1200px', margin: '0 auto', padding: '20px'}}>
        ...
        <section style={{marginBottom: '40px', padding: '20px', background: 'lightyellow', borderRadius: '10px'}}>
          <h2 style={{color: 'black', marginBottom: '20px'}}>3. ระบบการลงทะเบียนรายวิชา (Course Registration System)</h2>
          <div style={{background: 'white', padding: '20px', borderRadius: '10px', color: 'black'}}>
            <div style={{display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px'}}>
              <div>
  ...
  return (
    <div className="app">
      ...
      <main className="app-main" style={{maxWidth: '1200px', margin: '0 auto', padding: '20px'}}>
        ...
        {/* 4. Dropped Courses System - Testing Simple Version */}
        <section style={{marginBottom: '40px', padding: '20px', background: 'lightcoral', borderRadius: '10px'}}>
          <h2 style={{color: 'black', marginBottom: '20px'}}>4. ระบบรายวิชาที่ถอนแล้ว (Dropped Courses - Simple Test)</h2>
          <div style={{background: 'white', padding: '20px', borderRadius: '10px', color: 'black'}}>
            <CourseDropSimple />
          </div>
        </section>
